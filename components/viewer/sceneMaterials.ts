...
export const BAGASTUDIO_SHOWROOM_PREMIUM_PRESET: BagaStudioSceneMaterialPreset = {
  ...
  floor: {
    baseColor: "/textures/scene/showroom-premium/floor_basecolor.jpg",
    normal: "/textures/scene/showroom-premium/floor_normal.jpg",
    roughness: "/textures/scene/showroom-premium/floor_roughness.jpg",
    repeat: [1.25, 1.25],
    color: "#ffffff",
    roughnessValue: 0.68,
    metalnessValue: 0.02,
  ...
  wall: {
    baseColor: "/textures/scene/showroom-premium/wall_basecolor.jpg",
    normal: "/textures/scene/showroom-premium/wall_normal.jpg",
    roughness: "/textures/scene/showroom-premium/wall_roughness.jpg",
    repeat: [1.1, 0.9],
    color: "#ffffff",
    roughnessValue: 0.86,
    metalnessValue: 0.0,
    normalScale: [0.045, 0.045],
  },
  ceiling: {
    baseColor: "/textures/scene/showroom-premium/wall_basecolor.jpg",
    repeat: [1.2, 1.2],
